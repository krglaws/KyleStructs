...
$(STACKTESTTARG): $(TEST)/stack_tests.c $(TESTDEPS)
	$(CC) -g $^ -o $@


TESTDEPS := $(TREESETNODEDEPS) $(LISTNODEDEPS) $(DATACONTDEPS)
...
TESTDEPS := $(TREEMAPNODEDEPS) $(LISTNODEDEPS) $(DATACONTDEPS)
...
.PHONY: tests
tests: $(DATACONTTESTTARG) $(LISTNODETESTTARG) $(STACKTESTTARG) $(TREESETNODETESTTARG)\
        $(TREESETTESTTARG) $(HASHSETTESTTARG) $(TREEMAPNODETESTTARG) $(TREEMAPTESTTARG)\
        $(HASHMAPTESTTARG)
	@echo Finished building tests.


STATICLIB := libkylestructs.a
$(STATICLIB): $(DATACONTTARG) $(LISTNODETARG) $(STACKTARG) $(TREESETNODETARG) $(TREESETTARG)\
	       $(HASHSETTARG) $(TREEMAPNODETARG) $(TREEMAPTARG) $(HASHMAPTARG)
	ar rcs $(STATICLIB)\
		$(DATACONTTARG)\
		$(LISTNODETARG)\
		$(STACKTARG)\
...
$(DYNAMICLIB): $(DATACONTTARG) $(LISTNODETARG) $(STACKTARG) $(TREESETNODETARG) $(TREESETTARG)\
                $(HASHSETTARG) $(LISTNODETARG) $(TREEMAPNODETARG) $(TREEMAPTARG) $(HASHMAPTARG)
