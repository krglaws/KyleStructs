...
TESTDEPS := $(DATACONTDEPS) $(LISTNODEDEPS)
...
$(STATICLIB): $(DATACONTTARG) $(TREESETNODETARG) $(TREESETTARG) $(HASHSETTARG)\
...
$(DYNAMICLIB): $(DATACONTTARG) $(TREESETNODETARG) $(TREESETTARG) $(HASHSETTARG)\
	$(LISTNODETARG) $(TREEMAPNODETARG) $(TREEMAPTARG) $(HASHMAPTARG)
