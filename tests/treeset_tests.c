...
static int ks_treeset_new_tests()
{
  ...
  if (ts->root)
  {
    printf("TEST 1: ks_treeset should contain NULL 'root' ks_treesetnode* values.\n");
    retval = -1;
  }
...
static int ks_treeset_add_tests()
{
  ...
  {
    printf("TEST 1: Unexpected return value from ks_treeset_add(): %d. Expected: 0.\n", result);
    retval = -1;
  }
  ...
  {
    printf("TEST 2: Unexpected return value from ks_treeset_add(): %d. Expected 1.\n", result);
    retval = -1;
  }
  ...
  {
    printf("TEST 3: Unexpected return value from ks_treeset_add(): %d. Expected -1.\n", result);
    retval = -1;
  }
...
static int ks_treeset_remove_by_tests()
{
  ...
  {
    printf("TEST 1: Unexpected return value from ks_treeset_remove_by(): %d. Expected: 0.\n", result);
    retval = -1;
  }
  ...
  {
    printf("TEST 2: Unexpected return value from ks_treeset_remove_by(): %d. Expected: -1.\n", result);
    retval = -1;
  }
  ...
  {
    printf("TEST 3: Unexpected return value from ks_treeset_remove_by(): %d. Expected: -1.\n", result);
    retval = -1;
  }
...
static int ks_treeset_remove_at_tests()
{
  ...
  {
    printf("TEST 1: Unexpected return value from ks_treeset_remove_at(): %d. Expected: 0.\n", result);
    retval = -1;
  } 
  ...
  {
    printf("TEST 2: Unexpected return value from ks_treeset_remove_at(): %d. Expected: -1.\n", result);
    retval = -1;
  }
  ...
  {
    printf("TEST 3: Unexpected return value from ks_treeset_remove_at(): %d. Expected: -1.\n", result);
    retval = -1;
  }
...
static int ks_treeset_index_tests()
{
  ...
  {
    printf("TEST 1: Unexpected value returned from ks_treeset_index(): %d. Expected: 0.\n", index);
    retval = -1;
  }
  ...
  {
    printf("TEST 2: Unexpected value returned from ks_treeset_index(): %d. Expected: 1.\n", index);
    retval = -1;
  }
  ...
  {
    printf("TEST 3: Unexpected value returned from ks_treeset_index(): %d. Expected: 2.\n", index);
    retval = -1;
  }

  if ((index = ks_treeset_index(NULL, NULL)) != -1)
  {
    printf("TEST 4: Unexpected value returned from ks_treeset_index(): %d. Expected: -1.\n", index);
    retval = -1;
  }
...
static int ks_treeset_get_tests()
{
  ...
  if (get_dc->c != 'B')
  {
    printf("TEST 2: Unexpected ks_datacont value after ks_treeset_get(): %c. Expected: B.\n", get_dc->c);
    retval = -1;
  }
  ...
  if (get_dc != NULL)
  {
    printf("TEST 3: Unexpected ks_datacont value after OOB ks_treeset_get(): %c. Expected: NULL.\n", get_dc->c);
    retval = -1;
  }
...
static int ks_treeset_count_tests()
{
  ...
  if (count != 3)
  {
    printf("TEST 1: Unexpected value returned from ks_treeset_count(): %d. Expected: 3.\n", count);
    retval = -1;
  }
  ...
  if (count != 4)
  {
    printf("TEST 2: Unexpected value returned from ks_treeset_count(): %d. Expected 4.\n", count);
    retval = -1;
  }
  ...
  if (count != 0)
  {
    printf("TEST 3: Unexpected value returned from ks_treeset_count(): %d. Expected 0.\n", count);
    retval = -1;
  }
...
static int ks_treeset_height_tests()
{
  ...
  if (height != 0)
  {
    printf("TEST 2: Unexpected result from ks_treeset_height() on NULL param: %d. Expected: 0.\n", height);
    retval = -1;
  } 
...
static int ks_treeset_balance_tests()
{
  ...
  if (height != 26)
  {
    printf("TEST 1: ks_treeset_height() should have returned 26. Can't continue, quitting test...\n");
    ks_treeset_delete(ts);
    return -1;
  }
  ...
  if (height != 5)
  {
    printf("TEST 1: Unexpected tree height after ks_treeset_balance(): %d. Expected: 5.\n", height);
    retval = -1;
  }
