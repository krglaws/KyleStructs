...
static int ks_listnode_copy_all_tests() {
  ...
  if (ln_copy->dc->c != 'A' || ln_copy->next->dc->c != 'B') {
    printf(
        "TEST 1: Unexpected ks_datacont values after ks_listnode_copy_all()\n");
    retval = -1;
  }
...
static int ks_listnode_remove_by_tests() {
  ...
  if (ks_listnode_remove_by(NULL, dcA) != -1) {
    printf(
        "TEST 5: ks_listnode_remove_by() should return -1 when NULL params are "
        "passed\n");
    retval = -1;
  }
...
static int ks_listnode_remove_all_tests() {
  ...
  if ((num = ks_listnode_remove_all(&ln, dcA)) != 3) {
    printf(
        "TEST 1: ks_listnode_remove_all() should return the number of nodes "
  ...
  if ((num = ks_listnode_remove_all(&ln, dcB)) != 1) {
    printf(
        "TEST 2: ks_listnode_remove_all() should return the number of nodes "
  ...
  if ((num = ks_listnode_remove_all(&ln, dcB)) != 0) {
    printf(
        "TEST 3: ks_listnode_remove_all() should return the number of nodes "
  ...
  if ((num = ks_listnode_remove_all(&ln, dcC)) != 1) {
    printf(
        "TEST 4: ks_listnode_remove_all() should return the number of nodes "
        "removed. Returned: %d. Expected: 1\n",
        num);
    retval = -1;
  }
  ...
  if (ks_listnode_remove_all(&ln, dcC) != -1) {
    printf(
        "TEST 5: ks_listnode_remove_all() should return -1 when either param "
        "is NULL\n");
    retval = -1;
  }
...
static int ks_listnode_insert_tests() {
  ...
  if (get_dc->c != 'B') {
    printf(
        "TEST 2: Unexpected ks_datacont value at 2nd to last ks_listnode after "
