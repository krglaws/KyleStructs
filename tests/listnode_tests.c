...
static int ks_listnode_add_tests() {
    ...
    if (ks_listnode_add(NULL, dc) != -1) {
        printf(
            "TEST 1: ks_listnode_add() with any NULL parameters should return "
            "-1\n");
        retval = -1;
    }
    ...
    if (ln->dc->c != 'A') {
        printf(
            "TEST 2: unexpected ks_datacont value at first ks_listnode: %c. "
            "Expected: %c\n",
            ln->dc->c, 'A');
        retval = -1;
    }
    ...
    if (ln->next->dc->c != 'B') {
        printf(
            "TEST 2: unexpected ks_datacont value at second ks_listnode: %c. "
            "Expected: %c\n",
            ln->next->dc->c, 'B');
        retval = -1;
    }
...
static int ks_listnode_merge_tests() {
    ...
    if (ks_listnode_length(lna) != 2) {
        printf(
            "TEST 1: Unexpected ks_listnode length after "
            "ks_listnode_merge()\n");
        retval = -1;
    }
...
static int ks_listnode_remove_by_tests() {
    ...
    if (ks_listnode_remove_by(&ln, dcC) != 1) {
        printf(
            "TEST 1: ks_listnode_remove_by() should return 1 on successful "
            "removal\n");
        retval = -1;
    }
    ...
    if (ks_listnode_remove_by(&ln, dcC) != 0) {
        printf(
            "TEST 2: ks_listnode_remove_by() should return 0 when removing "
    ...
    if (ks_listnode_remove_by(&ln, dcB) != 1) {
        printf(
            "TEST 3: ks_listnode_remove_by() should return 1 on successful "
            "removal\n");
        retval = -1;
    }
    ...
    if (ks_listnode_remove_by(&ln, dcA) != 1) {
        printf(
            "TEST 4: ks_listnode_remove_by() should return 1 on successful "
            "removal\n");
        retval = -1;
    }
    ...
    if (ks_listnode_remove_by(NULL, dcA) != -1) {
        printf(
            "TEST 5: ks_listnode_remove_by() should return -1 when NULL params "
            "are "
            "passed\n");
        retval = -1;
    }
...
static int ks_listnode_remove_at_tests() {
    ...
    if (ks_listnode_remove_at(&ln, -1) != 0) {
        printf(
            "TEST 1: ks_listnode_remove_at() should return 0 on successful "
            "removal\n");
        retval = -1;
    }
    ...
    if (ks_listnode_remove_at(&ln, 10) != -1) {
        printf(
            "TEST 2: ks_listnode_remove_at() should return -1 on index OOB\n");
        retval = -1;
    }
    ...
    if (ks_listnode_remove_at(&ln, 0) != 0) {
        printf(
            "TEST 3: ks_listnode_remove_at() should return 0 on successful "
            "removal\n");
        retval = -1;
    }
    ...
    if (ks_listnode_remove_at(&ln, -1) != 0) {
        printf(
            "TEST 4: ks_listnode_remove_at() should return 0 on successful "
            "removal\n");
        retval = -1;
    }
    ...
    if (ks_listnode_remove_at(&ln, 0) != -1) {
        printf(
            "TEST 5: ks_listnode_remove_at() should return -1 when params are "
            "NULL\n");
        retval = -1;
    }
...
static int ks_listnode_remove_all_tests() {
    ...
    if ((num = ks_listnode_remove_all(&ln, dcA)) != 3) {
        printf(
            "TEST 1: ks_listnode_remove_all() should return the number of "
            "nodes "
    ...
    if ((num = ks_listnode_remove_all(&ln, dcB)) != 1) {
        printf(
            "TEST 2: ks_listnode_remove_all() should return the number of "
            "nodes "
    ...
    if ((num = ks_listnode_remove_all(&ln, dcB)) != 0) {
        printf(
            "TEST 3: ks_listnode_remove_all() should return the number of "
            "nodes "
    ...
    if ((num = ks_listnode_remove_all(&ln, dcC)) != 1) {
        printf(
            "TEST 4: ks_listnode_remove_all() should return the number of "
            "nodes "
            "removed. Returned: %d. Expected: 1\n",
            num);
        retval = -1;
    ...
    if (ks_listnode_remove_all(&ln, dcC) != -1) {
        printf(
            "TEST 5: ks_listnode_remove_all() should return -1 when either "
            "param "
            "is NULL\n");
        retval = -1;
    }
...
static int ks_listnode_replace_by_tests() {
    ...
    if (ks_listnode_replace_by(ln, dcB, ks_datacont_new("Z", KS_CHAR, 1)) !=
        0) {
        printf(
            "TEST 1: ks_listnode_replace_by() should return 0 on successful "
            "replacement\n");
        retval = -1;
    }
    ...
    if (get_dc->c != 'Z') {
        printf(
            "TEST 1: Unexpected ks_datacont value at 2nd ks_listnode following "
            "ks_listnode_replace_by(): %c. Expected Z\n",
            get_dc->c);
        retval = -1;
    }
    ...
    if (ks_listnode_replace_by(ln, dcB, dcB) != -1) {
        printf(
            "TEST 2: ks_listnode_replace_by() should return -1 when trying to "
            "remove not-present ks_datacont\n");
        retval = -1;
    }
    ...
    if (ks_listnode_replace_by(NULL, NULL, NULL) != -1) {
        printf(
            "TEST 3: ks_listnode_replace_by() should return -1 when params are "
            "NULL\n");
        retval = -1;
    }
...
static int ks_listnode_replace_at_tests() {
    ...
    if (ks_listnode_replace_at(ln, ks_datacont_new("Z", KS_CHAR, 1), 1) != 0) {
        printf(
            "TEST 1: ks_listnode_replace_at() should return 0 on successful "
            "replacement\n");
        retval = -1;
    }
    ...
    if (get_dc->c != 'Z') {
        printf(
            "TEST 1: Unexpected ks_datacont value at 2nd ks_listnode following "
            "ks_listnode_replace_at(): %c. Expected Z\n",
            get_dc->c);
        retval = -1;
    }
    ...
    if (ks_listnode_replace_at(ln, dcB, 10) != -1) {
        printf(
            "TEST 2: ks_listnode_replace_at() should return -1 when index is "
            "OOB\n");
        retval = -1;
    }
    ...
    if (ks_listnode_replace_at(NULL, NULL, 0) != -1) {
        printf(
            "TEST 3: ks_listnode_replace_at() should return -1 when params are "
            "NULL\n");
        retval = -1;
    }
...
static int ks_listnode_replace_all_tests() {
    ...
    if (ks_listnode_replace_all(ln, dcA, ks_datacont_new("Z", KS_CHAR, 1)) !=
        3) {
        printf(
            "TEST 1: ks_listnode_replace_all() should return the number of "
    ...
    if (get_dc->c != 'Z') {
        printf(
            ...
            "ks_listnode_replace_all(): %c. Expected: Z\n",
            get_dc->c);
        retval = -1;
    }
    ...
    if (ks_listnode_replace_all(ln, dcA, get_dc) != 0) {
        printf(
            "TEST 2: ks_listnode_replace_all() should return 0 when replacing "
...
static int ks_listnode_insert_tests() {
    ...
    if (ks_listnode_insert(&ln, ks_datacont_copy(dcB), 0) != 0) {
        printf(
            "TEST 1: ks_listnode_insert() should return 0 on successful "
            "insertion\n");
        retval = -1;
    }
    ...
    if (get_dc->c != 'B') {
        printf(
            "TEST 1: Unexpected ks_datacont value at first ks_listnode after "
            "ks_listnode_insert(): %c. Expected B\n",
            get_dc->c);
        retval = -1;
    }
    ...
    if (ks_listnode_insert(&ln, ks_datacont_copy(dcB), -1) != 0) {
        printf(
            "TEST 2: ks_listnode_insert() should return 0 on successful "
            "insertion\n");
        retval = -1;
    }
    ...
    if (get_dc->c != 'B') {
        printf(
            "TEST 2: Unexpected ks_datacont value at 2nd to last ks_listnode "
            "after "
            "ks_listnode_insert(): %d. Expected: B\n",
            get_dc->c);
        retval = -1;
    }
    ...
    if (ks_listnode_insert(&ln, NULL, 2) != -1) {
        printf(
            "TEST 3: ks_listnode_insert() should return -1 when any params are "
            "NULL\n");
        retval = -1;
    }
...
static int ks_listnode_index_tests() {
    ...
    if ((index = ks_listnode_index(ln, dcA)) != 0) {
        printf(
            "TEST 1: Unexpected index for ks_datacont value 'A': %d. Expected: "
            "0\n",
            index);
        retval = -1;
    }
    ...
    if ((index = ks_listnode_index(ln, dcB)) != 1) {
        printf(
            "TEST 2: Unexpected index for ks_datacont value 'B': %d. Expected: "
            "1\n",
            index);
        retval = -1;
    }
    ...
    if ((index = ks_listnode_index(ln, dcC)) != 2) {
        printf(
            "TEST 3: Unexpected index for ks_datacont value 'C': %d. Expected: "
            "2\n",
            index);
        retval = -1;
    }
...
static int ks_listnode_get_tests() {
    ...
    const ks_datacont* dcC = ks_listnode_get(ln, 2);
    if (dcC->c != 'C') {
    ...
    /* TEST 2 */
    const ks_datacont* dcA = ks_listnode_get(ln, 0);
    if (dcA->c != 'A') {
    ...
    /* TEST 3 */
    const ks_datacont* dcB = ks_listnode_get(ln, 1);
    if (dcB->c != 'B') {
...
static int ks_listnode_count_tests() {
    ...
    if ((count = ks_listnode_count(ln, dcA)) != 3) {
        printf(
            "TEST 1: Unexpected ks_listnode_count() result: %d. Expected: 3\n",
            count);
        retval = -1;
    }
    ...
    if ((count = ks_listnode_count(ln, dcB)) != 1) {
        printf(
            "TEST 2: Unexpected ks_listnode_count() result: %d. Expected: 1\n",
            count);
        retval = -1;
    }
...
static int ks_listnode_length_tests() {
    ...
    if ((len = ks_listnode_length(ln)) != 3) {
        printf(
            "TEST 1: Unexpected ks_listnode_length() result: %d. Expected: 3\n",
            len);
        retval = -1;
    }
